...
export const QuotePreview: React.FC<QuotePreviewProps> = ({ items, client, config, aiAnalysis, customLogo }) => {
  ...
  return (
    <div className="max-w-[1000px] mx-auto bg-white p-12 min-h-screen text-[#333] font-sans print:p-8 print:w-full print:max-w-none font-[Helvetica]">
      ...
      <div className="print-footer mt-auto pt-12 border-t border-slate-100 mt-20">
         <h4 className="font-bold uppercase text-[9px] mb-2 text-slate-900">TERMS & CONDITIONS</h4>
         <p className="italic mb-2 text-gray-500 whitespace-pre-wrap text-[8px] text-justify leading-relaxed">
            NEW PARTS TERMS / WARRANTY DISCLAIMER / LIMITATION OF LIABILITY: All products sold by American Iron LLC are brand new. Except as expressly stated in writing by Seller, Seller disclaims all warranties, express or implied, including any implied warranties of merchantability and fitness for a particular purpose. Any warranty coverage offered with the product (if any) is provided solely by the product’s manufacturer and is governed by the manufacturer’s warranty terms, procedures, and limitations; Seller does not control the repair or replacement of products and is not responsible for any consequential or incidental damages resulting from part failure.
         </p>
